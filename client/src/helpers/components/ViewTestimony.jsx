...
const ViewTestimony = ({ open, setOpen, category, files, submit }) => {
    ...
    return (
        <Modal
            ...
            <Box sx={style}>
                ...
                <Alert severity="info">
                    Esta es una previsualizacion del testimonio que se guardara, 
                    valide que la informacion sea correcta.
                </Alert>
                    <Grid item xs={6}>
